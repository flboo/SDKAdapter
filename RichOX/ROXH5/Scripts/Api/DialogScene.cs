...
namespace RichOX.Api
{
    ...
    {
        private IDialogSceneClient mClient;
    
        public DialogScene(string sceneId)
        {
            mClient = ClientFactory.BuildDialogSceneClient(sceneId);
            ConfigureDialogSceneEvents();
        }
        ...
        private void ConfigureDialogSceneEvents()
        {
