...
{
    public class FloatScene
    {
        private IFloatSceneClient mClient;

        public FloatScene(string sceneId)
        {
            mClient = ClientFactory.BuildFloatSceneClient(sceneId);
            ConfigureFloatSceneEvents();
        }
        ...
        private void ConfigureFloatSceneEvents()
        {
