    ...
    */
    ...
    public class PurchaseMgr : TMonoSingleton<PurchaseMgr>
    {
        ...
        public void DoPurchase(TDPurchase data)
        {
            ...
            DataAnalysisMgr.S.SatoriEvt_PurchaseRequest(data.id);
        }
        ...
        private class PurchaseSuccessTask : IThreadTask
        {
            ...
            public bool Execute()
            {
                ...
                DataAnalysisMgr.S.SatoriEvt_PurchaseSuccess(data.id, m_Product.receipt, m_Product.priceValue.ToString());
        ...
        public void OnProductPurchaseCancled(Product product, string res)
        {
            ...
            DataAnalysisMgr.S.SatoriEvt_PurchaseCancel(data.id, product.receipt, product.priceValue.ToString());
        }
        ...
        public void OnProductPurchaseFailed(Product product)
        {
            ...
            DataAnalysisMgr.S.SatoriEvt_PurchaseFailed(data.id, product.receipt, product.priceValue.ToString(), product.description);
        }
